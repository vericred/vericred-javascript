...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.DrugPackagesApi();
  });
  ...
  describe('DrugPackagesApi', function() {
    describe('showFormularyDrugPackageCoverage', function() {
      it('should call showFormularyDrugPackageCoverage successfully', function(done) {
        //uncomment below and update the code to test showFormularyDrugPackageCoverage
        //instance.showFormularyDrugPackageCoverage(pet, function(error) {
