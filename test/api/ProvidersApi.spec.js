...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.ProvidersApi();
  });
  ...
  describe('ProvidersApi', function() {
    describe('getProvider', function() {
      it('should call getProvider successfully', function(done) {
        ...
        //instance.getProvider(pet, function(error) {
    ...
    describe('getProviders', function() {
      it('should call getProviders successfully', function(done) {
        ...
        //instance.getProviders(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getProviders_0', function() {
      it('should call getProviders_0 successfully', function(done) {
        //uncomment below and update the code to test getProviders_0
        //instance.getProviders_0(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
