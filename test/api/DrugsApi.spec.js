...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.DrugsApi();
  });
  ...
  describe('DrugsApi', function() {
    describe('getDrugCoverages', function() {
      it('should call getDrugCoverages successfully', function(done) {
        //uncomment below and update the code to test getDrugCoverages
        //instance.getDrugCoverages(pet, function(error) {
    ...
    describe('listDrugs', function() {
      it('should call listDrugs successfully', function(done) {
        //uncomment below and update the code to test listDrugs
        //instance.listDrugs(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
