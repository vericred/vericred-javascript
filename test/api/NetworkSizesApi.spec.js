...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.NetworkSizesApi();
  });
  ...
  describe('NetworkSizesApi', function() {
    describe('listStateNetworkSizes', function() {
      it('should call listStateNetworkSizes successfully', function(done) {
        //uncomment below and update the code to test listStateNetworkSizes
        //instance.listStateNetworkSizes(pet, function(error) {
    ...
    describe('searchNetworkSizes', function() {
      it('should call searchNetworkSizes successfully', function(done) {
        //uncomment below and update the code to test searchNetworkSizes
        //instance.searchNetworkSizes(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
