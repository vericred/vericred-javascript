...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.NetworksApi();
  });
  ...
  describe('NetworksApi', function() {
    describe('createNetworkComparisons', function() {
      it('should call createNetworkComparisons successfully', function(done) {
        //uncomment below and update the code to test createNetworkComparisons
        //instance.createNetworkComparisons(pet, function(error) {
    ...
    describe('listNetworks', function() {
      it('should call listNetworks successfully', function(done) {
        ...
        //instance.listNetworks(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('showNetwork', function() {
      it('should call showNetwork successfully', function(done) {
        ...
        //instance.showNetwork(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
