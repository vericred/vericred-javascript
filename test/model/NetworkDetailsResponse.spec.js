...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.NetworkDetailsResponse();
  });
  ...
  describe('NetworkDetailsResponse', function() {
    it('should create an instance of NetworkDetailsResponse', function() {
      // uncomment below and update the code to test NetworkDetailsResponse
      //var instane = new vericredClient.NetworkDetailsResponse();
      //expect(instance).to.be.a(vericredClient.NetworkDetailsResponse);
    });
