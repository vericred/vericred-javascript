...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.NetworkDetails();
  });
  ...
  describe('NetworkDetails', function() {
    it('should create an instance of NetworkDetails', function() {
      // uncomment below and update the code to test NetworkDetails
      //var instane = new vericredClient.NetworkDetails();
      //expect(instance).to.be.a(vericredClient.NetworkDetails);
    });
    ...
    it('should have the property hiosIssuerIds (base name: "hios_issuer_ids")', function() {
      // uncomment below and update the code to test the property hiosIssuerIds
      //var instane = new vericredClient.NetworkDetails();
      //expect(instance).to.be();
    });
