...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.DentalPlanSearchRequest();
  });
  ...
  describe('DentalPlanSearchRequest', function() {
    it('should create an instance of DentalPlanSearchRequest', function() {
      // uncomment below and update the code to test DentalPlanSearchRequest
      //var instane = new vericredClient.DentalPlanSearchRequest();
      //expect(instance).to.be.a(vericredClient.DentalPlanSearchRequest);
    });
