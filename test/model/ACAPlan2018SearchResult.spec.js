...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.ACAPlan2018SearchResult();
  });
  ...
  describe('ACAPlan2018SearchResult', function() {
    it('should create an instance of ACAPlan2018SearchResult', function() {
      // uncomment below and update the code to test ACAPlan2018SearchResult
      //var instane = new vericredClient.ACAPlan2018SearchResult();
      //expect(instance).to.be.a(vericredClient.ACAPlan2018SearchResult);
    });
