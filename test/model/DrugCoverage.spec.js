...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.DrugCoverage();
  });
  ...
  describe('DrugCoverage', function() {
    it('should create an instance of DrugCoverage', function() {
      // uncomment below and update the code to test DrugCoverage
      //var instane = new vericredClient.DrugCoverage();
      //expect(instance).to.be.a(vericredClient.DrugCoverage);
    });
    ...
    it('should have the property drugPackageId (base name: "drug_package_id")', function() {
      // uncomment below and update the code to test the property drugPackageId
      //var instane = new vericredClient.DrugCoverage();
      //expect(instance).to.be();
    });
    ...
    it('should have the property priorAuthorization (base name: "prior_authorization")', function() {
      // uncomment below and update the code to test the property priorAuthorization
      //var instane = new vericredClient.DrugCoverage();
      //expect(instance).to.be();
    });
