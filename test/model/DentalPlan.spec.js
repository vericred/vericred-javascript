...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.DentalPlan();
  });
  ...
  describe('DentalPlan', function() {
    it('should create an instance of DentalPlan', function() {
      // uncomment below and update the code to test DentalPlan
      //var instane = new vericredClient.DentalPlan();
      //expect(instance).to.be.a(vericredClient.DentalPlan);
    });
