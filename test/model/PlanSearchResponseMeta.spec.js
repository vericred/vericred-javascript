...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.PlanSearchResponseMeta();
  });
  ...
  describe('PlanSearchResponseMeta', function() {
    it('should create an instance of PlanSearchResponseMeta', function() {
      // uncomment below and update the code to test PlanSearchResponseMeta
      //var instane = new vericredClient.PlanSearchResponseMeta();
      //expect(instance).to.be.a(vericredClient.PlanSearchResponseMeta);
    });
    ...
    it('should have the property eligibleForChipMedicaid (base name: "eligible_for_chip_medicaid")', function() {
      // uncomment below and update the code to test the property eligibleForChipMedicaid
      //var instane = new vericredClient.PlanSearchResponseMeta();
      //expect(instance).to.be();
    });
