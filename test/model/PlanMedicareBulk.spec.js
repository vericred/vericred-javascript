...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.PlanMedicareBulk();
  });
  ...
  describe('PlanMedicareBulk', function() {
    it('should create an instance of PlanMedicareBulk', function() {
      // uncomment below and update the code to test PlanMedicareBulk
      //var instane = new vericredClient.PlanMedicareBulk();
      //expect(instance).to.be.a(vericredClient.PlanMedicareBulk);
    });
    ...
    it('should have the property formularyName (base name: "formulary_name")', function() {
      // uncomment below and update the code to test the property formularyName
      //var instane = new vericredClient.PlanMedicareBulk();
      //expect(instance).to.be();
    });
