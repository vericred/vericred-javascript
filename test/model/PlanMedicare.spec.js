...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.PlanMedicare();
  });
  ...
  describe('PlanMedicare', function() {
    it('should create an instance of PlanMedicare', function() {
      // uncomment below and update the code to test PlanMedicare
      //var instane = new vericredClient.PlanMedicare();
      //expect(instance).to.be.a(vericredClient.PlanMedicare);
    });
