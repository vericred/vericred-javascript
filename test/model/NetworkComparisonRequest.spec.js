...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.NetworkComparisonRequest();
  });
  ...
  describe('NetworkComparisonRequest', function() {
    it('should create an instance of NetworkComparisonRequest', function() {
      // uncomment below and update the code to test NetworkComparisonRequest
      //var instane = new vericredClient.NetworkComparisonRequest();
      //expect(instance).to.be.a(vericredClient.NetworkComparisonRequest);
    });
