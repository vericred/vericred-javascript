...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.CarrierSubsidiary();
  });
  ...
  describe('CarrierSubsidiary', function() {
    it('should create an instance of CarrierSubsidiary', function() {
      // uncomment below and update the code to test CarrierSubsidiary
      //var instane = new vericredClient.CarrierSubsidiary();
      //expect(instance).to.be.a(vericredClient.CarrierSubsidiary);
    });
