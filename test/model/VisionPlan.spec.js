...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.VisionPlan();
  });
  ...
  describe('VisionPlan', function() {
    it('should create an instance of VisionPlan', function() {
      // uncomment below and update the code to test VisionPlan
      //var instane = new vericredClient.VisionPlan();
      //expect(instance).to.be.a(vericredClient.VisionPlan);
    });
