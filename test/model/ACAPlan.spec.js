...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.ACAPlan();
  });
  ...
  describe('ACAPlan', function() {
    it('should create an instance of ACAPlan', function() {
      // uncomment below and update the code to test ACAPlan
      //var instane = new vericredClient.ACAPlan();
      //expect(instance).to.be.a(vericredClient.ACAPlan);
    });
