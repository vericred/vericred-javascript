...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.PlanCounty();
  });
  ...
  describe('PlanCounty', function() {
    it('should create an instance of PlanCounty', function() {
      // uncomment below and update the code to test PlanCounty
      //var instane = new vericredClient.PlanCounty();
      //expect(instance).to.be.a(vericredClient.PlanCounty);
    });
