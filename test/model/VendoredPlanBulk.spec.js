...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.VendoredPlanBulk();
  });
  ...
  describe('VendoredPlanBulk', function() {
    it('should create an instance of VendoredPlanBulk', function() {
      // uncomment below and update the code to test VendoredPlanBulk
      //var instane = new vericredClient.VendoredPlanBulk();
      //expect(instance).to.be.a(vericredClient.VendoredPlanBulk);
    });
