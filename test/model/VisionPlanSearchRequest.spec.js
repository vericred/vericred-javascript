...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.VisionPlanSearchRequest();
  });
  ...
  describe('VisionPlanSearchRequest', function() {
    it('should create an instance of VisionPlanSearchRequest', function() {
      // uncomment below and update the code to test VisionPlanSearchRequest
      //var instane = new vericredClient.VisionPlanSearchRequest();
      //expect(instance).to.be.a(vericredClient.VisionPlanSearchRequest);
    });
