...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.ZipCountyBulk();
  });
  ...
  describe('ZipCountyBulk', function() {
    it('should create an instance of ZipCountyBulk', function() {
      // uncomment below and update the code to test ZipCountyBulk
      //var instane = new vericredClient.ZipCountyBulk();
      //expect(instance).to.be.a(vericredClient.ZipCountyBulk);
    });
