...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.ZipCounty();
  });
  ...
  describe('ZipCounty', function() {
    it('should create an instance of ZipCounty', function() {
      // uncomment below and update the code to test ZipCounty
      //var instane = new vericredClient.ZipCounty();
      //expect(instance).to.be.a(vericredClient.ZipCounty);
    });
