...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.RequestPlanFindApplicant();
  });
  ...
  describe('RequestPlanFindApplicant', function() {
    it('should create an instance of RequestPlanFindApplicant', function() {
      // uncomment below and update the code to test RequestPlanFindApplicant
      //var instane = new vericredClient.RequestPlanFindApplicant();
      //expect(instance).to.be.a(vericredClient.RequestPlanFindApplicant);
    });
