...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.ZipCountyResponse();
  });
  ...
  describe('ZipCountyResponse', function() {
    it('should create an instance of ZipCountyResponse', function() {
      // uncomment below and update the code to test ZipCountyResponse
      //var instane = new vericredClient.ZipCountyResponse();
      //expect(instance).to.be.a(vericredClient.ZipCountyResponse);
    });
    ...
    it('should have the property zipCounty (base name: "zip_county")', function() {
      // uncomment below and update the code to test the property zipCounty
      //var instane = new vericredClient.ZipCountyResponse();
      //expect(instance).to.be();
    });
