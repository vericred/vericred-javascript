...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.NetworkSearchResponse();
  });
  ...
  describe('NetworkSearchResponse', function() {
    it('should create an instance of NetworkSearchResponse', function() {
      // uncomment below and update the code to test NetworkSearchResponse
      //var instane = new vericredClient.NetworkSearchResponse();
      //expect(instance).to.be.a(vericredClient.NetworkSearchResponse);
    });
