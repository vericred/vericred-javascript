...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.PlanCountyBulk();
  });
  ...
  describe('PlanCountyBulk', function() {
    it('should create an instance of PlanCountyBulk', function() {
      // uncomment below and update the code to test PlanCountyBulk
      //var instane = new vericredClient.PlanCountyBulk();
      //expect(instance).to.be.a(vericredClient.PlanCountyBulk);
    });
