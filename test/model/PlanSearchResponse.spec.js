...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.PlanSearchResponse();
  });
  ...
  describe('PlanSearchResponse', function() {
    it('should create an instance of PlanSearchResponse', function() {
      // uncomment below and update the code to test PlanSearchResponse
      //var instane = new vericredClient.PlanSearchResponse();
      //expect(instance).to.be.a(vericredClient.PlanSearchResponse);
    });
