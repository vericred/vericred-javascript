...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.VisionPlanUpdate();
  });
  ...
  describe('VisionPlanUpdate', function() {
    it('should create an instance of VisionPlanUpdate', function() {
      // uncomment below and update the code to test VisionPlanUpdate
      //var instane = new vericredClient.VisionPlanUpdate();
      //expect(instance).to.be.a(vericredClient.VisionPlanUpdate);
    });
    ...
    it('should have the property issuerVericredId (base name: "issuer_vericred_id")', function() {
      // uncomment below and update the code to test the property issuerVericredId
      //var instane = new vericredClient.VisionPlanUpdate();
      //expect(instance).to.be();
    });
    ...
    it('should have the property standAlone (base name: "stand_alone")', function() {
