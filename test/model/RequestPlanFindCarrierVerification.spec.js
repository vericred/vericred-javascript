...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.RequestPlanFindCarrierVerification();
  });
  ...
  describe('RequestPlanFindCarrierVerification', function() {
    it('should create an instance of RequestPlanFindCarrierVerification', function() {
      // uncomment below and update the code to test RequestPlanFindCarrierVerification
      //var instane = new vericredClient.RequestPlanFindCarrierVerification();
      //expect(instance).to.be.a(vericredClient.RequestPlanFindCarrierVerification);
    });
    ...
    it('should have the property issuerVericredIds (base name: "issuer_vericred_ids")', function() {
      // uncomment below and update the code to test the property issuerVericredIds
      //var instane = new vericredClient.RequestPlanFindCarrierVerification();
      //expect(instance).to.be();
    });
