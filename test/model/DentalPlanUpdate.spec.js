...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.DentalPlanUpdate();
  });
  ...
  describe('DentalPlanUpdate', function() {
    it('should create an instance of DentalPlanUpdate', function() {
      // uncomment below and update the code to test DentalPlanUpdate
      //var instane = new vericredClient.DentalPlanUpdate();
      //expect(instance).to.be.a(vericredClient.DentalPlanUpdate);
    });
