...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.EmbargoRequest();
  });
  ...
  describe('EmbargoRequest', function() {
    it('should create an instance of EmbargoRequest', function() {
      // uncomment below and update the code to test EmbargoRequest
      //var instane = new vericredClient.EmbargoRequest();
      //expect(instance).to.be.a(vericredClient.EmbargoRequest);
    });
    ...
    it('should have the property productLine (base name: "product_line")', function() {
