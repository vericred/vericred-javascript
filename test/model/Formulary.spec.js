...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.Formulary();
  });
  ...
  describe('Formulary', function() {
    it('should create an instance of Formulary', function() {
      // uncomment below and update the code to test Formulary
      //var instane = new vericredClient.Formulary();
      //expect(instance).to.be.a(vericredClient.Formulary);
    });
