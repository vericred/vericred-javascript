...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.ProvidersGeocodeResponse();
  });
  ...
  describe('ProvidersGeocodeResponse', function() {
    it('should create an instance of ProvidersGeocodeResponse', function() {
      // uncomment below and update the code to test ProvidersGeocodeResponse
      //var instane = new vericredClient.ProvidersGeocodeResponse();
      //expect(instance).to.be.a(vericredClient.ProvidersGeocodeResponse);
    });
