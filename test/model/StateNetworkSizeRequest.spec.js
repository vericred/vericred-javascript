...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.StateNetworkSizeRequest();
  });
  ...
  describe('StateNetworkSizeRequest', function() {
    it('should create an instance of StateNetworkSizeRequest', function() {
      // uncomment below and update the code to test StateNetworkSizeRequest
      //var instane = new vericredClient.StateNetworkSizeRequest();
      //expect(instance).to.be.a(vericredClient.StateNetworkSizeRequest);
    });
