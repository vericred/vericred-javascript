...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.DrugSearchResponse();
  });
  ...
  describe('DrugSearchResponse', function() {
    it('should create an instance of DrugSearchResponse', function() {
      // uncomment below and update the code to test DrugSearchResponse
      //var instane = new vericredClient.DrugSearchResponse();
      //expect(instance).to.be.a(vericredClient.DrugSearchResponse);
    });
