...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.CountyBulk();
  });
  ...
  describe('CountyBulk', function() {
    it('should create an instance of CountyBulk', function() {
      // uncomment below and update the code to test CountyBulk
      //var instane = new vericredClient.CountyBulk();
      //expect(instance).to.be.a(vericredClient.CountyBulk);
    });
