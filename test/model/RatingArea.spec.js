...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.RatingArea();
  });
  ...
  describe('RatingArea', function() {
    it('should create an instance of RatingArea', function() {
      // uncomment below and update the code to test RatingArea
      //var instane = new vericredClient.RatingArea();
      //expect(instance).to.be.a(vericredClient.RatingArea);
    });
