...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.State();
  });
  ...
  describe('State', function() {
    it('should create an instance of State', function() {
      ...
      //var instane = new vericredClient.State();
      //expect(instance).to.be.a(vericredClient.State);
    });
    ...
    it('should have the property fipsNumber (base name: "fips_number")', function() {
      // uncomment below and update the code to test the property fipsNumber
      //var instane = new vericredClient.State();
      //expect(instance).to.be();
    });

    it('should have the property lastDateForIndividual (base name: "last_date_for_individual")', function() {
      // uncomment below and update the code to test the property lastDateForIndividual
      //var instane = new vericredClient.State();
      //expect(instance).to.be();
    });

    it('should have the property lastDateForShop (base name: "last_date_for_shop")', function() {
      // uncomment below and update the code to test the property lastDateForShop
      //var instane = new vericredClient.State();
      //expect(instance).to.be();
    });

    it('should have the property liveForBusiness (base name: "live_for_business")', function() {
      // uncomment below and update the code to test the property liveForBusiness
      //var instane = new vericredClient.State();
      //expect(instance).to.be();
    });

    it('should have the property liveForConsumers (base name: "live_for_consumers")', function() {
      // uncomment below and update the code to test the property liveForConsumers
      //var instane = new vericredClient.State();
      //expect(instance).to.be();
    });
