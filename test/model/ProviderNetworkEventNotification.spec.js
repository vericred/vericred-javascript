...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new vericredClient.ProviderNetworkEventNotification();
  });
  ...
  describe('ProviderNetworkEventNotification', function() {
    it('should create an instance of ProviderNetworkEventNotification', function() {
      // uncomment below and update the code to test ProviderNetworkEventNotification
      //var instane = new vericredClient.ProviderNetworkEventNotification();
      //expect(instance).to.be.a(vericredClient.ProviderNetworkEventNotification);
    });
