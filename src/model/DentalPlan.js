...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.vericredClient.DentalPlan = factory(root.vericredClient.ApiClient, root.vericredClient.DentalPlanBenefits, root.vericredClient.PlanIdentifier);
  }
  ...
  /**
   * Constructs a new <code>DentalPlan</code>.
   * @alias module:model/DentalPlan
   * @class
   */
  ...
  /**
   * Constructs a <code>DentalPlan</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DentalPlan} obj Optional instance to populate.
   * @return {module:model/DentalPlan} The populated <code>DentalPlan</code> instance.
   */
