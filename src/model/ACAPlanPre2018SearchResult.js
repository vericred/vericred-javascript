...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.vericredClient.ACAPlanPre2018SearchResult = factory(root.vericredClient.ApiClient, root.vericredClient.PlanIdentifier);
  }
  ...
  /**
   * The ACAPlanPre2018SearchResult model module.
   * @module model/ACAPlanPre2018SearchResult
   * @version 0.0.10
   */

  /**
   * Constructs a new <code>ACAPlanPre2018SearchResult</code>.
   * @alias module:model/ACAPlanPre2018SearchResult
   * @class
   */
  ...
  /**
   * Constructs a <code>ACAPlanPre2018SearchResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ACAPlanPre2018SearchResult} obj Optional instance to populate.
   * @return {module:model/ACAPlanPre2018SearchResult} The populated <code>ACAPlanPre2018SearchResult</code> instance.
   */
