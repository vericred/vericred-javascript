...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.vericredClient.EmbargoRequest = factory(root.vericredClient.ApiClient);
  }
  ...
  /**
   * The EmbargoRequest model module.
   * @module model/EmbargoRequest
   * @version 0.0.12
   */

  /**
   * Constructs a new <code>EmbargoRequest</code>.
   * @alias module:model/EmbargoRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>EmbargoRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EmbargoRequest} obj Optional instance to populate.
   * @return {module:model/EmbargoRequest} The populated <code>EmbargoRequest</code> instance.
   */
   ...
   */
  exports.prototype['product_line'] = undefined;
  /**
