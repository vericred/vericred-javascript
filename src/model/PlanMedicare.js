...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.vericredClient.PlanMedicare = factory(root.vericredClient.ApiClient, root.vericredClient.PlanIdentifier);
  }
  ...
  /**
   * The PlanMedicare model module.
   * @module model/PlanMedicare
   * @version 0.0.10
   */

  /**
   * Constructs a new <code>PlanMedicare</code>.
   * @alias module:model/PlanMedicare
   * @class
   */
  ...
  /**
   * Constructs a <code>PlanMedicare</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PlanMedicare} obj Optional instance to populate.
   * @return {module:model/PlanMedicare} The populated <code>PlanMedicare</code> instance.
   */
