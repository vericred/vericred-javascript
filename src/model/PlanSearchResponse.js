...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ACAPlan', 'model/DrugCoverage', 'model/Meta'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ACAPlan'), require('./DrugCoverage'), require('./Meta'));
  } else {
    // Browser globals (root is window)
    if (!root.vericredClient) {
      root.vericredClient = {};
    }
    root.vericredClient.PlanSearchResponse = factory(root.vericredClient.ApiClient, root.vericredClient.ACAPlan, root.vericredClient.DrugCoverage, root.vericredClient.Meta);
  }
}(this, function(ApiClient, ACAPlan, DrugCoverage, Meta) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('plans')) {
        obj['plans'] = ApiClient.convertToType(data['plans'], [ACAPlan]);
      }
    }
    return obj;
  }
  ...
  /**
   * Plan search results
   * @member {Array.<module:model/ACAPlan>} plans
   */
