...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('polygon')) {
        obj['polygon'] = ApiClient.convertToType(data['polygon'], 'Number');
      }
      ...
      if (data.hasOwnProperty('sort_seed')) {
        obj['sort_seed'] = ApiClient.convertToType(data['sort_seed'], 'Number');
      }
   ...
   * @member {Number} polygon
   */
  exports.prototype['polygon'] = undefined;
  /**
   ...
   * @member {Number} sort_seed
   */
  exports.prototype['sort_seed'] = undefined;
  /**
