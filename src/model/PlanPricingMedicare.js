...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.vericredClient.PlanPricingMedicare = factory(root.vericredClient.ApiClient);
  }
  ...
  /**
   * The PlanPricingMedicare model module.
   * @module model/PlanPricingMedicare
   * @version 0.0.11
   */

  /**
   * Constructs a new <code>PlanPricingMedicare</code>.
   * @alias module:model/PlanPricingMedicare
   * @class
   */
  ...
  /**
   * Constructs a <code>PlanPricingMedicare</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PlanPricingMedicare} obj Optional instance to populate.
   * @return {module:model/PlanPricingMedicare} The populated <code>PlanPricingMedicare</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('health_premium')) {
        obj['health_premium'] = ApiClient.convertToType(data['health_premium'], 'Number');
      }
      if (data.hasOwnProperty('drug_premium')) {
        obj['drug_premium'] = ApiClient.convertToType(data['drug_premium'], 'Number');
      }
   ...
   * @member {Number} health_premium
   */
  exports.prototype['health_premium'] = undefined;
  /**
   * Medicare Advantage drug premium
   * @member {Number} drug_premium
   */
  exports.prototype['drug_premium'] = undefined;
  /**
