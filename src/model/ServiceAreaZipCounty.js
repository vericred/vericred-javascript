...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.vericredClient.ServiceAreaZipCounty = factory(root.vericredClient.ApiClient);
  }
  ...
  /**
   * The ServiceAreaZipCounty model module.
   * @module model/ServiceAreaZipCounty
   * @version 0.0.12
   */

  /**
   * Constructs a new <code>ServiceAreaZipCounty</code>.
   * @alias module:model/ServiceAreaZipCounty
   * @class
   */
  ...
  /**
   * Constructs a <code>ServiceAreaZipCounty</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ServiceAreaZipCounty} obj Optional instance to populate.
   * @return {module:model/ServiceAreaZipCounty} The populated <code>ServiceAreaZipCounty</code> instance.
   */
