...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.vericredClient.ACAPlanPre2018 = factory(root.vericredClient.ApiClient, root.vericredClient.PlanIdentifier);
  }
  ...
  /**
   * The ACAPlanPre2018 model module.
   * @module model/ACAPlanPre2018
   * @version 0.0.12
   */

  /**
   * Constructs a new <code>ACAPlanPre2018</code>.
   * @alias module:model/ACAPlanPre2018
   * @class
   */
  ...
  /**
   * Constructs a <code>ACAPlanPre2018</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ACAPlanPre2018} obj Optional instance to populate.
   * @return {module:model/ACAPlanPre2018} The populated <code>ACAPlanPre2018</code> instance.
   */
