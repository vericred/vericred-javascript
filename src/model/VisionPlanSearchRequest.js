...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/VisionPlanSearchApplicant'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./VisionPlanSearchApplicant'));
  } else {
    // Browser globals (root is window)
    if (!root.vericredClient) {
      root.vericredClient = {};
    }
    root.vericredClient.VisionPlanSearchRequest = factory(root.vericredClient.ApiClient, root.vericredClient.VisionPlanSearchApplicant);
  }
}(this, function(ApiClient, VisionPlanSearchApplicant) {
  'use strict';
  ...
  /**
   * The VisionPlanSearchRequest model module.
   * @module model/VisionPlanSearchRequest
   * @version 0.0.12
   */

  /**
   * Constructs a new <code>VisionPlanSearchRequest</code>.
   * @alias module:model/VisionPlanSearchRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>VisionPlanSearchRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VisionPlanSearchRequest} obj Optional instance to populate.
   * @return {module:model/VisionPlanSearchRequest} The populated <code>VisionPlanSearchRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('applicants')) {
        obj['applicants'] = ApiClient.convertToType(data['applicants'], [VisionPlanSearchApplicant]);
      }
   ...
   * @member {Array.<module:model/VisionPlanSearchApplicant>} applicants
   */
