...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.vericredClient.PlanSearchResponseMeta = factory(root.vericredClient.ApiClient);
  }
  ...
  /**
   * The PlanSearchResponseMeta model module.
   * @module model/PlanSearchResponseMeta
   * @version 0.0.8
   */

  /**
   * Constructs a new <code>PlanSearchResponseMeta</code>.
   * @alias module:model/PlanSearchResponseMeta
   * @class
   */
  ...
  /**
   * Constructs a <code>PlanSearchResponseMeta</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PlanSearchResponseMeta} obj Optional instance to populate.
   * @return {module:model/PlanSearchResponseMeta} The populated <code>PlanSearchResponseMeta</code> instance.
   */
