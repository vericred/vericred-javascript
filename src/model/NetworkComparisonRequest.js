...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.vericredClient.NetworkComparisonRequest = factory(root.vericredClient.ApiClient);
  }
  ...
  /**
   * The NetworkComparisonRequest model module.
   * @module model/NetworkComparisonRequest
   * @version 0.0.11
   */

  /**
   * Constructs a new <code>NetworkComparisonRequest</code>.
   * @alias module:model/NetworkComparisonRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>NetworkComparisonRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NetworkComparisonRequest} obj Optional instance to populate.
   * @return {module:model/NetworkComparisonRequest} The populated <code>NetworkComparisonRequest</code> instance.
   */
