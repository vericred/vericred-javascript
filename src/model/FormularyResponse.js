...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Formulary', 'model/Meta'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Formulary'), require('./Meta'));
  } else {
    // Browser globals (root is window)
    if (!root.vericredClient) {
      root.vericredClient = {};
    }
    root.vericredClient.FormularyResponse = factory(root.vericredClient.ApiClient, root.vericredClient.Formulary, root.vericredClient.Meta);
  }
}(this, function(ApiClient, Formulary, Meta) {
  'use strict';
  ...
  /**
   * Constructs a new <code>FormularyResponse</code>.
   * @alias module:model/FormularyResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>FormularyResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FormularyResponse} obj Optional instance to populate.
   * @return {module:model/FormularyResponse} The populated <code>FormularyResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('formularies')) {
        obj['formularies'] = ApiClient.convertToType(data['formularies'], [Formulary]);
      }
    }
    return obj;
  }
  ...
  /**
   * List of formularies.
   * @member {Array.<module:model/Formulary>} formularies
   */
  exports.prototype['formularies'] = undefined;
