...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DentalPlanSearchApplicant'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DentalPlanSearchApplicant'));
  } else {
    // Browser globals (root is window)
    if (!root.vericredClient) {
      root.vericredClient = {};
    }
    root.vericredClient.DentalPlanSearchRequest = factory(root.vericredClient.ApiClient, root.vericredClient.DentalPlanSearchApplicant);
  }
}(this, function(ApiClient, DentalPlanSearchApplicant) {
  'use strict';
  ...
  /**
   * The DentalPlanSearchRequest model module.
   * @module model/DentalPlanSearchRequest
   * @version 0.0.12
   */

  /**
   * Constructs a new <code>DentalPlanSearchRequest</code>.
   * @alias module:model/DentalPlanSearchRequest
   * @class
   */
  ...
  /**
   * Constructs a <code>DentalPlanSearchRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DentalPlanSearchRequest} obj Optional instance to populate.
   * @return {module:model/DentalPlanSearchRequest} The populated <code>DentalPlanSearchRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('applicants')) {
        obj['applicants'] = ApiClient.convertToType(data['applicants'], [DentalPlanSearchApplicant]);
      }
   ...
   * @member {Array.<module:model/DentalPlanSearchApplicant>} applicants
   */
