...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.vericredClient.VisionPlan = factory(root.vericredClient.ApiClient, root.vericredClient.PlanIdentifier, root.vericredClient.VisionPlanBenefits);
  }
  ...
  /**
   * Constructs a new <code>VisionPlan</code>.
   * @alias module:model/VisionPlan
   * @class
   */
  ...
  /**
   * Constructs a <code>VisionPlan</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VisionPlan} obj Optional instance to populate.
   * @return {module:model/VisionPlan} The populated <code>VisionPlan</code> instance.
   */
