...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.vericredClient.MedicalPlansApi = factory(root.vericredClient.ApiClient, root.vericredClient.PlanSearchResponse, root.vericredClient.RequestPlanFind, root.vericredClient.PlanShowResponse);
  }
}(this, function(ApiClient, PlanSearchResponse, RequestPlanFind, PlanShowResponse) {
  'use strict';

  /**
   * MedicalPlans service.
   * @module api/MedicalPlansApi
   * @version 0.0.12
   */

  /**
   * Constructs a new MedicalPlansApi. 
   * @alias module:api/MedicalPlansApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/MedicalPlansApi~findPlansCallback
     ...
     * @param {module:api/MedicalPlansApi~findPlansCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/MedicalPlansApi~showPlanCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/MedicalPlansApi~showPlanCallback} callback The callback function, accepting three arguments: error, data, response
