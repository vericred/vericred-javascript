...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.vericredClient.DrugCoveragesApi = factory(root.vericredClient.ApiClient, root.vericredClient.DrugCoverageResponse);
  }
}(this, function(ApiClient, DrugCoverageResponse) {
  'use strict';

  /**
   * DrugCoverages service.
   * @module api/DrugCoveragesApi
   * @version 0.0.12
   */

  /**
   * Constructs a new DrugCoveragesApi. 
   * @alias module:api/DrugCoveragesApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/DrugCoveragesApi~getDrugCoveragesCallback
     ...
     * @param {String} audience Plan Audience (individual or small_group)
     * @param {String} stateCode Two-character state code
     * @param {module:api/DrugCoveragesApi~getDrugCoveragesCallback} callback The callback function, accepting three arguments: error, data, response
